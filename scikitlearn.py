...
mlp = MLPClassifier(hidden_layer_sizes=(64, 32, 16, 8), max_iter=400, alpha=1e-8, activation = "relu",
                        solver='adam', verbose=True, shuffle=True, early_stopping = False, tol=1e-12, 
>>>>>>> 6a0e88bfd451dc3f95aa993db518608503d78d1e
